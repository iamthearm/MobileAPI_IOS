...
public protocol ContactCenterCommunicating {
    // MARK: - Initialization
    /// Base URL to make requests. Usually matches the tenantURL.
    /// - Tag: baseURL
    var baseURL: URL { get }
    /// Identifies your tenant within contact center provider system.
    ...
    /// It must be generated by the mobile application in the UUID format.
    /// - Tag: clientID
